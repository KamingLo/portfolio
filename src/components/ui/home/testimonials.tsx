...
export const Testimonials = () => (
  <Section id="testimonials" data-aos="fade-up" className="text-zinc-700 [-webkit-tap-highlight-color:transparent]">
    <div className="max-w-[1440px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-6 border-b border-zinc-100 pb-10">
        <div className="space-y-3">
          ...
          <h2 className="text-5xl md:text-8xl font-semibold text-zinc-900 tracking-tight">
            Impact
          </h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
        ...
        <div className="lg:col-span-7 relative group">
          ...
          <div className="relative p-10 md:p-16 border border-zinc-200 backdrop-blur-md overflow-hidden transition-all duration-300 hover:border-blue-500/20 active:border-blue-500 active:bg-blue-500/5">
            ...
            <div className="relative z-10 space-y-10">
              ...
              <p className="text-2xl md:text-4xl text-zinc-900 font-semibold tracking-tight group-active:text-blue-500 transition-colors duration-300">
              ...
              <div className="flex items-center gap-5 pt-4">
                <div className="w-16 h-16 flex items-center justify-center text-blue-500 text-xl font-semibold border border-blue-200">
                  SP
                </div>
                <div>
                  <div className="text-xl font-semibold text-zinc-900 tracking-tight">SMK Pelita IV</div>
        ...
        <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-12">
          {Stats.map((stat, i) => (
            <div key={i} className="group space-y-4 active:scale-95 transition-transform duration-200">
              <div className="text-7xl md:text-9xl font-semibold tracking-tight text-zinc-900 group-hover:text-blue-500 group-active:text-blue-500 transition-colors duration-500">
                {stat.val}
              </div>
              ...
              <div className="text-zinc-500 text-base md:text-lg font-semibold">
                {stat.label}
              </div>
            </div>
          ))}
